...
BEGIN;
    ...
    (4, 'TRANSFER_INFO','employee_sections',4),
    (5, 'SERVICE_EXTENSION_INFO','employee_sections',5),
    (6, 'DISABILITY_INFO','employee_sections',6),
    (7, 'GROUP_INSURANCE','employee_sections',7),
    (8, 'DISCUSSION_INFO','employee_sections',8),
    (9, 'ADVANCES_INFO','employee_sections',9),
    (10, 'MEDICAL_CONDITIONS','employee_sections',10),
    (11, 'SERVICE_BOOK_INFO','employee_sections',11),
    (12, 'CERTIFICATE_INFO','employee_sections',12),
